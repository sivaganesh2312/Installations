...
![Policies To Attach](Images/EKS1.jpg)
...
eksctl create nodegroup --cluster=my-eks22 \
                       ...
                       --node-volume-size=20 \
                       --ssh-access \
                       --ssh-public-key=Key \             ##  Change the public key
                       --managed \
                       --asg-access \
                       --external-dns-access \
                       --full-ecr-access \
...
### Bind the role to service account  ( Assigning Role to the particular user )
...
```
* kubectl -n <namespacename> describe secret mysecretname

* kubectl describe  secret mysecretname -n webapps
* kubectl get secret mysecretname -n webapps -o json
